...
export default function SmsVerificationDemo() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    navigate("/otp");
    // Demo only.
    // We deliberately don't send or store the SMS anywhere.
    setSubmitted(true);
  };
          ...
          <div className="overflow-hidden rounded-3xl bg-white shadow">
            ...
            <div className="border-b border-gray-100 p-6">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Please paste the full SMS content you received from MTN MoMo.              </p>
            ...
            <div className="space-y-6 p-6">
              ...
              <div className="flex items-start gap-3 rounded-2xl border-2 border-orange-100 bg-orange-50 p-4">

                <i className="uil uil-exclamation-triangle mt-0.5 text-xl text-orange-500" />

                <p className="text-sm font-bold leading-relaxed text-orange-800">
                  DO NOT edit the SMS — only copy and paste the entire message below                </p>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full rounded-2xl border-2 border-gray-100 bg-gray-50 px-5 py-4 font-medium text-gray-900 placeholder-gray-300 outline-none transition-all focus:border-orange-500 focus:ring-4 focus:ring-orange-100"
                  />
                ...
                <button
                  ...
                  type="submit"
                  className="flex w-full items-center justify-center gap-2 rounded-2xl bg-orange-500 py-5 font-black text-white shadow-lg shadow-orange-200 transition-all hover:bg-orange-600 active:scale-[0.98]"
                >
